...
function custom_taxonomy() {
    register_taxonomy('custom_section',  'staff', [
        'labels' => [
            'name' => 'Разделы',
...
function custom_meta_boxes() {
    add_meta_box('custom_excerpt_box', 'Краткое описание', 'custom_excerpt_box_callback', 'staff', 'normal', 'default');
    add_meta_box('custom_thumbnail_box', 'Изображение (превью)', 'custom_thumbnail_box_callback', 'staff', 'side', 'default');
}
